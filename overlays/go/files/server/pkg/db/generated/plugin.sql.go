...
SELECT id, workspace_id, name, description, content, config, created_by, created_at, updated_at, plugin_installation_id, scope, owner_user_id FROM skill WHERE plugin_installation_id = $1 ORDER BY name ASC
`
